...
import { PortfolioWithServices } from "@/components/portfolio-with-services"
    ...
    <div className="min-h-screen">
      ...
      <section className="relative z-10 py-16 sm:py-20 bg-[#101010] rounded-t-[32px] sm:rounded-t-[48px] -mt-16 sm:-mt-20">
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          {/* Section Header */}
          <div className="mb-8">
            <h2 className="text-3xl sm:text-4xl font-bold text-white" style={{ fontFamily: 'LOT, sans-serif' }}>
              {activeTab === "portfolio" ? "Portafolio" : "Servicios"}
            </h2>
          ...
          {/* Portfolio with Services component */}
          <PortfolioWithServices activeTab={activeTab} onTabChange={setActiveTab} />
        </div>
      </section>
    </div>
  )
