...
const features = [
  {
    ...
    description: "Encuentra eventos únicos adaptados a tus gustos.",
  },
  {
    icon: ShieldCheck,
    title: "Seguridad",
    description: "Compra con confianza en nuestra plataforma protegida.",
  },
  {
    icon: Layers,
    title: "Variedad",
    description: "Miles de eventos en múltiples categorías.",
  },
  {
    icon: Zap,
    title: "Instantáneo",
    description: "Tickets digitales al momento en tu dispositivo.",
  },
];
      ...
      <div className="w-full max-w-6xl space-y-12 relative z-10">
        <div className="flex flex-col items-center text-center space-y-8">
          <Badge variant="secondary" className="backdrop-blur-sm bg-white/10 border border-white/20 text-white hover:bg-white/20 px-4 py-2 rounded-full">
            ✨ La Nueva Era de Eventos
          </Badge>

          <div className="space-y-6 flex items-center justify-center flex-col ">
            <h1 className="text-3xl md:text-6xl font-semibold tracking-tight max-w-3xl" style={{ fontFamily: 'LOT, sans-serif' }}>
              Descubre experiencias inolvidables con <span className="text-primary">HUNT</span>
            </h1>
            <p className="text-lg text-neutral-300 max-w-2xl">
              La plataforma líder para descubrir, comprar y disfrutar los mejores eventos.
              Conectamos personas con experiencias únicas en toda Latinoamérica.
            </p>
