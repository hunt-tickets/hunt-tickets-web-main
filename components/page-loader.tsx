...
export function PageLoader() {
  ...
  useEffect(() => {
    ...
    // morphTime = 1.5s per transition, cooldownTime = 0.5s
    // Total: (1.5s + 0.5s) * 3 transitions = 6 seconds for H→U→N→T
    const totalDuration = 8000 // 8 seconds to account for morphing + display time
